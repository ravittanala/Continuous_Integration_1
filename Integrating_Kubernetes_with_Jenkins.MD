...
#### From Jenkins home page select "New Item"
   ...
   - *Source Code Management:*
      - Repository: `https://github.com/ravittanala/Continuous_Integration_1.git`
  ...
  - *Post-build Actions*  
    - Send build artifacts over SSH  
      - *SSH Publishers*  
	       - Exec command: 
                ```sh 
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-ravittanala-deployment.yml;
                ansible-playbook -i /opt/docker/hosts /opt/docker/kubernetes-ravittanala-service.yml;
                ```
Save and run the job.
